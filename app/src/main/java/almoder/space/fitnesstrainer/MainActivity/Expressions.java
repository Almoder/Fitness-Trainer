...
public class Expressions {
    ...
    public static boolean isFragmentOpened(CharSequence toolbarTitle, String title) {
        if (toolbarTitle == null) {
            throw new NullPointerException(toolbarTitleIsNull);
        }
        if (title == null) {
            throw new NullPointerException(titleIsNull);
        }
        return toolbarTitle.equals(title);
    }

    public static boolean isArticlesOpened(int title) {
        return title == R.string.m3;
    }
    ...
    public static boolean isBackStackHasEntries(int count) {
        return count > 1;
    }

    public static boolean editTextIsVisible(EditText editText) {
        if (editText == null) {
            throw new NullPointerException(editTextIsNull);
        }
